...
def parse_dict_header(value: str) -> dict[str, str | None]:
    ...
    `RFC 2231 <https://www.rfc-editor.org/rfc/rfc2231
...
_parameter_key_re = re.compile(r"([\w!
_parameter_token_value_re = re.compile(r"[\w!
...
def parse_options_header(value: str | None) -> tuple[str, dict[str, str]]:
    ...
    value. The `HTML Standard <https://html.spec.whatwg.org/
...
_cookie_no_quote_re = re.compile(r"[\w!
