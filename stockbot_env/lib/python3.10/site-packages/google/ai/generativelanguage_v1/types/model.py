...
class Model(proto.Message):
    ...
    .. _oneof: https://proto-plus-python.readthedocs.io/en/stable/fields.html

    Attributes:
        name (str):
            Required. The resource name of the ``Model``. Refer to
            `Model
            variants <https://ai.google.dev/gemini-api/docs/models/gemini
        ...
        top_p (float):
            For `Nucleus
            sampling <https://ai.google.dev/gemini-api/docs/prompting-strategies
