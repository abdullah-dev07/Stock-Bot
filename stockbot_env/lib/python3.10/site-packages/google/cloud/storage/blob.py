...
class Blob(_PropertyMixin):
    ...
    def encryption_key(self, value):
        ...
        See https://cloud.google.com/storage/docs/encryption/using-customer-supplied-keys?hl=ca
    ...
    def generate_signed_url(
        ...
        See a [code sample](https://cloud.google.com/storage/docs/samples/storage-generate-signed-url-v4
    ...
    def download_to_filename(
        ...
        See a [code sample](https://cloud.google.com/storage/docs/samples/storage-download-encrypted-file
        to download a file with a [`customer-supplied encryption key`](https://cloud.google.com/storage/docs/encryption
    ...
    def upload_from_filename(
        ...
        See a [code sample](https://cloud.google.com/storage/docs/samples/storage-upload-encrypted-file
        to upload a file with a
        [`customer-supplied encryption key`](https://cloud.google.com/storage/docs/encryption
    ...
    def create_resumable_upload_session(
        ...
        documentation on [`signed URLs`](https://cloud.google.com/storage/docs/access-control/signed-urls
        ...
        a [`customer-supplied`](https://cloud.google.com/storage/docs/encryption
        encryption key.
    ...
    def compose(
        ...
        and a [code sample](https://cloud.google.com/storage/docs/samples/storage-compose-file
    ...
    See [`RFC 7234`](https://tools.ietf.org/html/rfc7234
    ...
    See [`RFC 6266`](https://tools.ietf.org/html/rfc7234
    ...
    See [`RFC 4960`](https://tools.ietf.org/html/rfc4960
    [`API reference docs`](https://cloud.google.com/storage/docs/json_api/v1/objects).
    ...
    def etag(self):
        ...
        See [`RFC 2616 (etags)`](https://tools.ietf.org/html/rfc2616
        [`API reference docs`](https://cloud.google.com/storage/docs/json_api/v1/objects).
