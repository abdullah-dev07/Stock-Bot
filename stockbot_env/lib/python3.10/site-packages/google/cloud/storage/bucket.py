...
class Bucket(_PropertyMixin):
    ...
    def get_blob(
        ...
        **kwargs,
        ...
        See a [code sample](https://cloud.google.com/storage/docs/samples/storage-get-metadata
    ...
    def get_notification(
        ...
        and a [code sample](https://cloud.google.com/storage/docs/samples/storage-print-pubsub-bucket-notification
    ...
    def copy_blob(
        ...
        and a [code sample](https://cloud.google.com/storage/docs/samples/storage-copy-file
    ...
    def add_lifecycle_delete_rule(self, **kw):
        ...
        See also a [code sample](https://cloud.google.com/storage/docs/samples/storage-enable-bucket-lifecycle-management
    ...
    def configure_website(self, main_page_suffix=None, not_found_page=None):
        ...
        .. note::
          ...
          [code samples](https://cloud.google.com/storage/docs/samples/storage-define-bucket-website-configuration
    ...
    def get_iam_policy(
        ...
        and a [code sample](https://cloud.google.com/storage/docs/samples/storage-view-bucket-iam-members
    ...
    def generate_upload_policy(self, conditions, expiration=None, client=None):
        ...
        See a [code sample](https://cloud.google.com/storage/docs/xml-api/post-object-forms
