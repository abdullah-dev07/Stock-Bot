...
def _parse_topic_path(topic_path):
    ...
    (see [`resource manager docs`](https://cloud.google.com/resource-manager/reference/rest/v1beta1/projects
    ...
    encoding, see [`topic spec`](https://cloud.google.com/storage/docs/json_api/v1/notifications/insert
