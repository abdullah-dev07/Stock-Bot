...
from google.cloud._helpers import _datetime_to_pb_timestamp, UTC  
...
class FirestoreBundle:
    ...
    def add_document(self, snapshot: DocumentSnapshot) -> "FirestoreBundle":
        ...
        if original_document:
            original_queries = original_document.metadata.queries  
    ...
    def _save_documents_from_query(
        ...
        for doc in query.stream():  
            ...
            bundled_document.metadata.queries.append(query_name)  
    ...
    def _add_bundle_element(self, bundle_element: BundleElement, *, client: BaseClient, type: str):  
        ...
        if type == "metadata":
            self._deserialized_metadata = bundle_element.metadata  
        elif type == "namedQuery":
            self.named_queries[bundle_element.named_query.name] = bundle_element.named_query  
            ...
            snapshot = DocumentSnapshot(
                ...
                create_time=bundle_element.document.create_time,  
                update_time=bundle_element.document.update_time,  
            )
    ...
    def build(self) -> str:
        ...
        bundled_document: "_BundledDocument"  
