...
def test_latex_to_png_color():
    ...
    mpl_hexwhite = latextools.latex_to_png_mpl(latex_string, False, '
...
def test_latex_to_png_invalid_hex_colors():
    ...
    pytest.raises(
        ...
        lambda: latextools.latex_to_png(
            latex_string, backend="dvipng", color="
        ),
    )
    pytest.raises(
        ValueError,
        lambda: latextools.latex_to_png(latex_string, backend="dvipng", color="
    )
