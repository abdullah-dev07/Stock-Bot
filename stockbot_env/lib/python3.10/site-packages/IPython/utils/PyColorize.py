...
NoColor = ColorScheme(
    ...
    'in_prompt'      : InputTermColors.NoColor,  
    'in_number'      : InputTermColors.NoColor,  
    'in_prompt2'     : InputTermColors.NoColor, 
    'in_normal'      : InputTermColors.NoColor,  

    'out_prompt'     : Colors.NoColor, 
    'out_number'     : Colors.NoColor, 

    'normal'         : Colors.NoColor  
    }  )
