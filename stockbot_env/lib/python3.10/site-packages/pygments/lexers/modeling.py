...
class ModelicaLexer(RegexLexer):
    ...
    tokens = {
        ...
        'class': [
            ...
            (r'(if|for|when|while)\b', Keyword.Reserved, '
            (_name, Name.Class, '
            default('
        ],
        'package-prefix': [
...
class BugsLexer(RegexLexer):
    ...
    From http://www.openbugs.info/Manuals/ModelSpecification.html
    ...
    Functions from
    http://www.openbugs.info/Manuals/ModelSpecification.html
    """
