...
class SMLLexer(RegexLexer):
    ...
    tokens = {
        ...
        'delimiters': [
            ...
            (r'\b(do|else|end|in|then)\b(?!\')', Keyword.Reserved, '
        ],
        ...
        'dotted': [
            ...
            (rf'({alphanumid_re})', end_id_callback, "
            (rf'({symbolicid_re})', end_id_callback, "
            (r'\s+', Error),
            (r'\S+', Error),
        ],
        ...
        'breakout': [
            (r'(?=\b({})\b(?!\'))'.format('|'.join(alphanumid_reserved)), Text, '
        ],
        ...
        'fname': [
            ...
            (rf'({alphanumid_re})', Name.Function, '
            (rf'({symbolicid_re})', Name.Function, '
        ...
        'vname': [
            ...
            (rf'({symbolicid_re})(\s*)(=(?!{symbolicid_re}))',
             bygroups(Name.Variable, Text, Punctuation), '
            (rf'({alphanumid_re})', Name.Variable, '
            (rf'({symbolicid_re})', Name.Variable, '
        ...
        'datbind': [
            ...
            (r'\b(and)\b(?!\')', Keyword.Reserved, ('
            (r'\b(withtype)\b(?!\')', Keyword.Reserved, ('
        ...
        'datcon': [
            include('whitespace'),
            (rf'({alphanumid_re})', Name.Class, '
            (rf'({symbolicid_re})', Name.Class, '
            (r'\S+', Error, '
        ],
