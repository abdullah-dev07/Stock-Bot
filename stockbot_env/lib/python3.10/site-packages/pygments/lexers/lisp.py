...
class SchemeLexer(RegexLexer):
    ...
    tokens = {
        ...
        'value': [
            ...
            (number_rules[2], Number.Bin, '
            (number_rules[8], Number.Oct, '
            (number_rules[10], decimal_cb, '
            (number_rules[16], Number.Hex, '
...
class RacketLexer(RegexLexer):
    ...
    _exact_decimal_prefix = r'(?:
    _exponent = r'(?:[defls][-+]?\d+)'
    _inexact_simple_no_hashes = r'(?:\d+(?:/\d+|\.\d*)?|\.\d+)'
    _inexact_simple = (rf'(?:{_inexact_simple_no_hashes}|(?:\d+
                       r'\d+(?:\.\d*
    ...
    tokens = {
        ...
        'datum': [
            ...
            (rf'(?i){_exact_decimal_prefix}[-+]?\d+(?=[{_delimiters}])',
             Number.Integer, '
            (rf'(?i){_exact_decimal_prefix}[-+]?(\d+(\.\d*)?|\.\d+)([deflst][-+]?\d+)?(?=[{_delimiters}])', Number.Float, '
            (rf'(?i){_exact_decimal_prefix}[-+]?({_inexact_normal_no_hashes}([-+]{_inexact_normal_no_hashes}?i)?|[-+]{_inexact_normal_no_hashes}?i)(?=[{_delimiters}])', Number, '
            ...
            (rf'(?i)(([-+]?{_inexact_simple}t[-+]?\d+)|[-+](inf|nan)\.t)(?=[{_delimiters}])', Number.Float, '
        ...
        'list': [
            (_closing_parenthesis, Punctuation, '
        ],
        'unquoted-datum': [
            include('datum'),
