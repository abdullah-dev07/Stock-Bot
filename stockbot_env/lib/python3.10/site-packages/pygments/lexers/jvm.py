...
class KotlinLexer(RegexLexer):
    ...
    tokens = {
        ...
        'function': [
            (r'<', Operator, 'generic'),
            (r'' + kt_id + r'(\.)' + kt_id, bygroups(Name, Punctuation, Name.Function), '
            (kt_id, Name.Function, '
        ],
        'generic': [
...
class JasminLexer(RegexLexer):
    ...
    tokens = {
        ...
        'annotation-body': [
            (r'\n+', Whitespace),
            (rf'\.end{_break}', Keyword.Reserved, '
            include('default'),
        ...
        'field': [
            (rf'static{_break}', Keyword.Reserved, ('
            include('default'),
        ...
        'no-verification': [
            (rf'(locals|method|stack){_break}', Keyword.Reserved, '
            include('default')
        ],
        'static': [
            include('default'),
        ...
        'verification': [
            include('default'),
            (rf'(Double|Float|Integer|Long|Null|Top|UninitializedThis){_break}', Keyword, '
            (rf'Object{_break}', Keyword, ('
            (rf'Uninitialized{_break}', Keyword, ('
        ]
    }
