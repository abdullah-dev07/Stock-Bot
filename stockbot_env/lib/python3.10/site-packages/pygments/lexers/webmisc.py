...
class XQueryLexer(ExtendedRegexLexer):
    ...
    elementcontentchar = r'[A-Za-z]|\s|\d|[!"
    
    
    quotattrcontentchar = r'[A-Za-z]|\s|\d|[!
    
    
    aposattrcontentchar = r'[A-Za-z]|\s|\d|[!"
    ...
    tokens = {
        ...
        'operator': [
            ...
            (r'ascending|descending|default', Keyword, '
            (r'(allowing)(\s+)(empty)',
             bygroups(Keyword, Whitespace, Keyword)),
            (r'external', Keyword),
        ...
        'xmlspace_decl': [
            include('whitespace'),
            (r'\(:', Comment, 'comment'),
            (r'preserve|strip', Keyword, '
        ],
        'declareordering': [
            (r'\(:', Comment, 'comment'),
            include('whitespace'),
            (r'ordered|unordered', Keyword, '
        ],
        'xqueryversion': [
            include('whitespace'),
            (r'\(:', Comment, 'comment'),
