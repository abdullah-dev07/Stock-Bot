...
class MozPreprocHashLexer(RegexLexer):
    """
    Lexer for Mozilla Preprocessor files (with '
    ...
    tokens = {
        ...
        'exprstart': [
            (r'(literal)(.*)', bygroups(Comment.Preproc, Text), '
            (words((
...
class WikitextLexer(RegexLexer):
    ...
    def plaintext_tag_rules(tag_name):
        return [
            (rf'(?si)(.*?)(</)({tag_name})(\s*)(>)', bygroups(Text,
             Punctuation, Name.Tag, Whitespace, Punctuation), '
        ]
    ...
    parser_functions_i = {
        ...
        'FULLURL', 'FULLURLE', 'GENDER', 'GRAMMAR', 'INT', r'\
    ...
    tokens = {
        ...
        'inline-italic-bold': [
            include('quote-common'),
            (r"(''')('')(?!')", bygroups(
                Generic.EmphStrong, Generic.Emph), '
            (r"'''(?!')", Generic.EmphStrong, ('
            (r"''(?!')", Generic.EmphStrong, ('
            include('inline'),
            include('text-bold-italic'),
