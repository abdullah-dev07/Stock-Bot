...
class HaskellLexer(RegexLexer):
    ...
    tokens = {
        ...
        'escape': [
            ...
            (r'\^[][' + uni.Lu + r'@^_]', String.Escape, '
            ('|'.join(ascii), String.Escape, '
            (r'o[0-7]+', String.Escape, '
            (r'x[\da-fA-F]+', String.Escape, '
            (r'\d+', String.Escape, '
            (r'(\s+)(\\)', bygroups(Whitespace, String.Escape), '
        ],
    }
