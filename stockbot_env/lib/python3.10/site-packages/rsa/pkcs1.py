...
This module implements certain functionality from PKCS
very clear example, read http://www.di-mgt.com.au/rsa_alg.html
...
def encrypt(message: bytes, pub_key: key.PublicKey) -> bytes:
    """Encrypts the given message using PKCS
...
def decrypt(crypto: bytes, priv_key: key.PrivateKey) -> bytes:
    r"""Decrypts the given message using PKCS
    ...
    >>> crypto = encrypt(b'hello', pub_key)
    >>> crypto = crypto[0:5] + b'X' + crypto[6:] 
    >>> decrypt(crypto, priv_key)
