...
class FieldInfo(_repr.Representation):
    ...
    def from_annotated_attribute(
        ...
        class MyModel(pydantic.BaseModel):
            foo: int = 4  
            bar: Annotated[int, annotated_types.Gt(4)] = 4  
            spam: Annotated[int, pydantic.Field(gt=4)] = 4  
        ```
    ...
    **extra: Unpack[_EmptyKwargs],
    ...
    Args:
        ...
        union_mode: The strategy to apply when validating a union. Can be `smart` (the default), or `left_to_right`.
            See [Union Mode](../concepts/unions.md
...
def PrivateAttr(
    ...
    *,
    ...
    """!!! abstract "Usage Documentation"
        [Private Model Attributes](../concepts/models.md
...
def computed_field(
    ...
    *,
    ...
    """!!! abstract "Usage Documentation"
        [The `computed_field` decorator](../concepts/fields.md
