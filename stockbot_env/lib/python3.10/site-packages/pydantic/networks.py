...
class _BaseUrl:
    ...
    def scheme(self) -> str:
        ...
        e.g. `https` in `https://user:pass@host:port/path?query
        """
    ...
    def username(self) -> str | None:
        ...
        e.g. `user` in `https://user:pass@host:port/path?query
        """
    ...
    def password(self) -> str | None:
        ...
        e.g. `pass` in `https://user:pass@host:port/path?query
        """
    ...
    def unicode_host(self) -> str | None:
        ...
        e.g. `host` in `https://user:pass@host:port/path?query
    ...
    def port(self) -> int | None:
        ...
        e.g. `port` in `https://user:pass@host:port/path?query
        """
    ...
    def path(self) -> str | None:
        ...
        e.g. `/path` in `https://user:pass@host:port/path?query
        """
    ...
    def query(self) -> str | None:
        ...
        e.g. `query` in `https://user:pass@host:port/path?query
        """
    ...
    def query_params(self) -> list[tuple[str, str]]:
        ...
        e.g. `[('foo', 'bar')]` in `https://user:pass@host:port/path?foo=bar
        """
    ...
    def fragment(self) -> str | None:
        ...
        e.g. `fragment` in `https://user:pass@host:port/path?query
        """
...
class _BaseMultiHostUrl:
    ...
    def scheme(self) -> str:
        ...
        e.g. `https` in `https://foo.com,bar.com/path?query
        """
        return self._url.scheme
    ...
    def path(self) -> str | None:
        ...
        e.g. `/path` in `https://foo.com,bar.com/path?query
        """
        return self._url.path
    ...
    def query(self) -> str | None:
        ...
        e.g. `query` in `https://foo.com,bar.com/path?query
        """
        return self._url.query
    ...
    def query_params(self) -> list[tuple[str, str]]:
        ...
        e.g. `[('foo', 'bar')]` in `https://foo.com,bar.com/path?foo=bar
        """
        return self._url.query_params()
    ...
    def fragment(self) -> str | None:
        ...
        e.g. `fragment` in `https://foo.com,bar.com/path?query
        """
        return self._url.fragment
...
class AnyUrl(_BaseUrl):
    ...
    * Host not required
    ...
    Assuming an input URL of `http://samuel:pass@example.com:8000/the/path/?query=here
