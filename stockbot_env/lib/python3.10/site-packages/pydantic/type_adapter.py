...
class TypeAdapter(Generic[T]):
    ...
    **Note:** `TypeAdapter` instances are not types, and cannot be used as type annotations for fields.
    ...
    Args:
        ...
        config: Configuration for the `TypeAdapter`, should be a dictionary conforming to
            ...
            !!! note
                ...
                [`type-adapter-config-unused`](../errors/usage_errors.md
    ...
    ??? tip "Compatibility with `mypy`"
        ...
        ta: TypeAdapter[Union[str, int]] = TypeAdapter(Union[str, int])  
        ```
        ...
        *,
        ...
        Args:
            ...
            experimental_allow_partial: **Experimental** whether to enable
                [partial validation](../concepts/experimental.md
    ...
    def dump_json(
        ...
        *,
        ...
        """!!! abstract "Usage Documentation"
            [JSON Serialization](../concepts/json.md
