...
class WebSocketCommonProtocol(asyncio.Protocol):
    ...
    .. _Pong: https://datatracker.ietf.org/doc/html/rfc6455
    ...
    * on the server side, when the connection handler terminates.
    ...
    def open(self) -> bool:
        ...
        .. _EAFP: https://docs.python.org/3/glossary.html
    ...
    async def recv(self) -> Data:
        ...
        Returns:
            ...
            .. _Binary: https://datatracker.ietf.org/doc/html/rfc6455
    ...
    async def send(
        ...
        .. _fragmentation: https://datatracker.ietf.org/doc/html/rfc6455
